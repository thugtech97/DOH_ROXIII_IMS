  ...
  if(mysqli_num_rows($sql) != 0){
    while($row = mysqli_fetch_assoc($sql)) {
      ...
      $ics_tbody.="<tr>
                  ...
                  <td colspan=\"2\" style=\"width: 48px; height: 14.5px; text-align: left; font-size: 10px; vertical-align: center; border-bottom-color: rgb(0, 0, 0); border-bottom-width: 1px; border-bottom-style: solid; border-right-color: rgb(0, 0, 0); border-right-width: 1px; border-right-style: solid;\">".$row["description"]."</td>
