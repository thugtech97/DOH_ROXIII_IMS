...
function print_ris(){
	...
	while($row = mysqli_fetch_assoc($sql)){
		...
		if($row["available"] == 1){
	        ...
	        <td style=\"width: 115.8px; height: 13.5px; text-align: left; font-size: 9px; vertical-align: center; border-bottom-color: rgb(0, 0, 0); border-bottom-width: 1px; border-bottom-style: solid;border-right-color: rgb(0, 0, 0); border-right-width: 1px; border-right-style: solid;\">".$row["description"]."</td>
