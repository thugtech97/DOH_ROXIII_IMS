                ...
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        ...
                        <ul class="nav navbar-top-links navbar-left">
                            ...
                            <span class="m-r-sm text-muted welcome-message"><?php echo $_SESSION["link1"]; ?> | Inspection and Acceptance Report</span>
                        </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-12 animated bounceInDown">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5><i class="fa fa-houzz"></i> Inspection and Acceptance Report</h5>
                        </div>
