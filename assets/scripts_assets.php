...
?>
    ...
    <!-- Ladda -->
    <script src="<?php echo $base_url; ?>/js/plugins/ladda/spin.min.js"></script>
    <script src="<?php echo $base_url; ?>/js/plugins/ladda/ladda.min.js"></script>
    <script src="<?php echo $base_url; ?>/js/plugins/ladda/ladda.jquery.min.js"></script>
