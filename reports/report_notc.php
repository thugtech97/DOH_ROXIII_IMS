<div id="report_notc" style="display: none;">
      ...
      <tr>
        <td>
          <div class="page dl_content">
            <center><h3>NOTICE OF TERMINATION OF CONTRACT</h3></center>
            <p class="dl_date"></p>
            ...
            <p>Dear Ma'am/Sir:</p><p>Greetings!</p><p style="text-align: justify;">This is in reference to the DOH-Center for Health Development-Caraga approved Purchase Order No. <span id="notc-po" style="font-weight: bold;"><b>(SELECT PO NUMBER)</b></span> for the Procurement of <span id="notc-items" style="font-weight: bold;"><b>(SELECT PO NUMBER)</b></span> was conformed last <span id="notc-dc" style="font-weight: bold;"><b>(SELECT PO NUMBER)</b></span>, that is beyond the delivery term of <span id="notc-dt"><b>(SELECT PO NUMBER)</b></span>.</p>
            ...
            <p style="text-align: justify;">Attached herewith is copy of above- mentioned purchase order for your reference.</p>
