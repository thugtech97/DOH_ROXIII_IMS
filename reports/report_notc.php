      ...
      <tr>
        <td>
          <div class="page dl_content">
            ...
            <p>Dear Ma'am/Sir:</p><p>Greetings!</p><p style="text-align: justify;">This is in reference to the DOH-Center for Health Development-Caraga approved Purchase Order No. <span id="notc-po"><b>(SELECT PO NUMBER)</b></span> for the Procurement of <span id="notc-items"><b>(SELECT PO NUMBER)</b></span> was conformed last <span id="notc-dc"><b>(SELECT PO NUMBER)</b></span>, that is beyond the delivery term of <span id="notc-dt"><b>(SELECT PO NUMBER)</b></span>.</p>
