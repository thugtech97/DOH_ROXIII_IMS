...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/archives';
        ...
        <div class="col-12">
            ...
            if($is_onlineViewer) {
                if($online_viewer == 'google') {
                    echo '<iframe src="' . fm_enc($file_url) . '" frameborder="no" style="width:100%;min-height:100vh"></iframe>';
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">DOH-CARAGA-IMS</a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">DOH-CARAGA-IMS</a></div>
        <?php endif; ?>
    </div>
</form>
