                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="from" type="text" class="form-control" value="Department of Health - CHD - Caraga">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select id="storage_temp" class="form-control select2_demo_1">
                                            <option disabled selected></option>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="alloc_num" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Transport Temp.:</label>
                                    <div class="col-lg-9">
                                        <select id="transport_temp" class="form-control select2_demo_1">
                                            <option disabled selected></option>
                                            <option>At room temperature, not exceeding 30°</option>
                                            <option>Keep between +2°c and +8°c (in a refrigerator)</option>
                                        </select>
