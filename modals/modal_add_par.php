<div class="modal inmodal" id="add_par" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false" data-focus="false">
    <div class="modal-dialog modal-lg">
    <div class="modal-content animated slideInDown">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                <h5 class="modal-title"><i class="fa fa-plus"></i> Add PAR</h5>
            </div>
            <div class="modal-body">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <i class="fa fa-info-circle"></i> Property Acknowledgement Receipt Information
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">PAR Number:</label>
                                    <div class="col-lg-9">
                                        <input type="text" data-pc="<?php echo $_SESSION["property_custodian"]; ?>" id="par_no" placeholder="XXXX-XX-XXXX" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select id="par_area" class="form-control select2_demo_1">
                                            <option disabled selected></option>
                                        </select> 
                                    </div>
                                </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="height: 220px; overflow: auto;">
                        <table id="par_items" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>PO Number</th>
